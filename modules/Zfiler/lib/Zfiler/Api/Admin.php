 ...
 * @license GNU/GPL
 */
class Zfiler_Api_Admin extends Zikula_AbstractApi
{
    /**
    ...
    public function getLinks()
    {
        ...
        if (SecurityUtil::checkPermission('Zfiler::', '::', ACCESS_ADMIN)) {
            $links[] = array(
                'url' => ModUtil::url($this->name, 'admin', 'elfinder'),
                'text' => $this->__('Elfinder'),
        ...
        if (SecurityUtil::checkPermission('Zfiler::', '::', ACCESS_ADMIN)) {
            $links[] = array(
                'url' => 'https://github.com/nmpetkov/Zfiler/wiki',
                'text' => $this->__('Wiki'),
    ...
    {
        $dir = $this->getVar('zfiler_backupsdir');
    ...
    {
        $dir = $this->getVar('zfiler_scriptsdir');
